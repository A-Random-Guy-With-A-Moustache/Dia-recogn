...
ADAPTERS_DIR = MODELS_DIR / "adapters_bf16_4B"
MAX_IMAGE_DIM = 1024
...
def init_model():
    ...
    base_path = MODELS_DIR / "analyzer-4B"
...
with gr.Blocks(title="(4B) VLM DSL и помощник по вопросам") as demo:
    gr.Markdown("Интерфейс модели VLM с адаптерами (4B bf16)")
